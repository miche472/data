...
# Calculate change in lean, fat, total body mass, adiposity index ####
...
#### USE-- Percent change in BW ####
BW_pct_change_plot <-ggplot(echmoMRI_Exp1_delta, 
                              aes(x=n_measurement, y=BW_pct_change, group=DRUG, fill=DRUG, color=DRUG)) +
  geom_point(stat = "summary", 
             fun = "mean", aes(color=DRUG), size=4) +
  geom_line(stat = "summary", 
            fun = "mean", aes(color=DRUG), linewidth=1) +
  ...
  labs(y= "ΔBody weight (%)",
       title= "Percent change in total body weight",
       color="Treatment", fill="Treatment")
BW_pct_change_plot

#### USE--Percent change in Lean mass ####
...
#### USE - Percent change in fat mass from initial fat mass ####
Fat_pct_change_plot <-ggplot(echmoMRI_Exp1_delta, 
                              aes(x=n_measurement, y=Fat_pct_change, group=DRUG, fill=DRUG, color=DRUG)) +
  geom_point(stat = "summary", 
             fun = "mean", aes(color=DRUG), size=4) +
  geom_line(stat = "summary", 
            fun = "mean", aes(color=DRUG), linewidth=1) +
...
#### USE--Percent of BW comprised of lean mass ####
...
#### USE--Percent of BW comprised of fat mass ####
Fat_pct_of_BW_plot <-ggplot(echmoMRI_Exp1_delta,
                            aes(x=n_measurement, y=Fat_pct_BW, 
