...
#For now say the light cycle is 7pm to 6am...need to extract actual time (not just hr) 
#from DateTime to be able to do 6:30am and pm
...
##zt_time option 2 ####
#This method gives decimal values for zt_time and accounts for the 6:30 to 18:30 cycle
zt_time <- function(DateTime){
  time <- hour(DateTime) + minute(DateTime)/60
  zt <- time - 18.5
