...
#Daily food intake during BW loss -- by ID
...
ggplot(GLP1_BWloss_plot2, aes(x = Inject_day, y = BWloss_cum_INTAKE_kcal, color = ID, fill = ID)) +
  ...
  labs(x="Treatment day",
       ...
       title= "Cumulative FI during BW loss (n=11)")

#---
#Cumulative FI during BW loss - trajectory for each treatment group
