...
mutate(
    ...
    Inject_day= case_when(COMMENTS=="INJECT_DAY_ONE"~0, 
                          ...
                          COMMENTS=="INJECT_DAY_SEVENTEEN"~16,
                          COMMENTS=="INJECT_DAY_EIGHTEEN"~17,
                          COMMENTS=="INJECT_DAY_NINETEEN"~18,
                          COMMENTS=="INJECT_DAY_TWENTY"~19,
                          COMMENTS=="INJECT_DAY_TWENTY_ONE"~20), 
...
ggplot(GLP1_BWloss_plot2, aes(x = Inject_day, y = BWloss_cum_INTAKE_kcal, color = ID, fill = ID)) +
  geom_line(linewidth = 1.2) +
  geom_point() +
  scale_x_continuous(breaks = scales::pretty_breaks(n = 10))+
  #facet_wrap(~ID) +
  ...
  labs(x="Day",
       ...
       title= "Cumulative FI during BW loss")
...
ggplot(manual_check, aes(x = Inject_day)) +
  geom_line(aes(y = BW_pct_change, color = "BW (% change)")) +
  geom_point(aes(y = BW_pct_change, color = "BW (% change)"), color="#F8766D") +
    geom_label(aes(y = BW_pct_change, label = round(BW_pct_change,1), nudge_y = -4, 
                   color="BW (% change)"), size=3, color="#F8766D") +
  geom_line(aes(y = corrected_intake_gr, color = "Daily FI (g)")) +
  geom_point(aes(y = corrected_intake_gr, color = "Daily FI (g)"), color="#619CFF") +
  geom_label(aes(y = corrected_intake_gr, label = round(corrected_intake_gr,1), nudge_y = 5, 
                 color="Daily FI (g)"), size=3, color="#619CFF") +
  ...
  labs(x="Treatment day",
       title= "Trajectory of FI and BW loss (n=11)") +
  facet_wrap(~ID)
...
ggplot(SVD_manual_check, aes(x = Inject_day)) +
  ...
  geom_label(aes(y = BW_pct_change, label = round(BW_pct_change,1), nudge_y = -4, 
                 color="BW (% change)"), size=3, color="#F8766D") +
  geom_line(aes(y = corrected_intake_gr, color = "Daily FI (grams)")) +
  geom_point(aes(y = corrected_intake_gr, color = "Daily FI (grams)"), color="#619CFF") +
  geom_label(aes(y = corrected_intake_gr, label = round(corrected_intake_gr,1), nudge_y = 5, 
                 color="Daily FI (grams)"), size=3, color="#619CFF") +
  geom_hline(yintercept = 0) +
  scale_x_continuous(breaks = scales::pretty_breaks(n = 10))+
  theme_bw(base_size = 14) +
  theme(legend.position = "right",
        ...
        legend.text = element_text(size = 14)) +
  labs(x="Treatment day",
       title= "Survodutide: Trajectory of FI and BW loss (n=4)") +
  facet_wrap(~ID)
...
ggplot(TZP_manual_check, aes(x = Inject_day)) +
  ...
  theme(legend.position = "right",
        ...
        legend.text = element_text(size = 14)) +
  labs(x="Treatment day",
       title= "Tirzepatide: Trajectory of FI and BW loss (n=4)") +
  facet_wrap(~ID)
...
ggplot(Vehicle_manual_check, aes(x = Inject_day)) +
  ...
  geom_point(aes(y = BW_pct_change, color = "BW (% change)"), color="#F8766D") +
  geom_label(aes(y = BW_pct_change, label = round(BW_pct_change,1), nudge_y = -4, 
                 color="BW (% change)"), size=5, color="#F8766D") +
  geom_line(aes(y = corrected_intake_gr, color = "Daily FI (grams)")) +
  geom_point(aes(y = corrected_intake_gr, color = "Daily FI (grams)"), color="#619CFF") +
  geom_label(aes(y = corrected_intake_gr, label = round(corrected_intake_gr,1), nudge_y = 5, 
                 color="Daily FI (grams)"), size=5, color="#619CFF") +
  geom_hline(yintercept = 0) +
  scale_x_continuous(breaks = scales::pretty_breaks(n = 10))+
  theme_bw(base_size = 14) +
  theme(legend.position = "right",
        ...
        legend.text = element_text(size = 14)) +
  labs(x="Treatment day",
       title= "Control: Trajectory of FI and BW loss (n=3)") +
  facet_wrap(~ID)
