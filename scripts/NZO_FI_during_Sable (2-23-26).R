...
#Important note: the manual food measurements for GROUPS/measurement time points other than 
      #Restricted, BW loss or BW maintenance are calculated using the incorrect method for FI measurements
      #Don't use manual FI measurements unless I revise script to use INTAKE_GR not corrected_intake_kcal

#This script started as a cleaned up version of NZO_FI (LM Rev. 1-30-26)
#Script started: 1-30-26
#Date of last revision: 2-23-26

#In this script I look at the concurrent FI and EE rather than FI during time periods between Sable measurements

# Bottom of this script:Used mouse 3706 to establish a script for extracting FI data from 
        #sable recording ("Establishing method using 3706")
...
#Bar bar plot for manually measured avg. daily FI during sable recording
...
#custom_colors <- c("Control" = "#FAAC41", "Weight cycled" = "#3498DB") # Define custom colors
