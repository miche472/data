...
#Next step -> pick up where I left off on 1-28-26. I need to extract the manual FI information during BW loss for weight cycled mice
...
summarise (Avg_two_days= mean(total_eaten_gr), .groups = "drop") %>%
...
#Start of 1-_-26 work

#### Use manual FI measurements from Sable recording at BW loss for Weight cycled mice ####
#Need to connect the complete days to dates...start with one ID = 3708
#Look at FI.csv. Need morning and evening of complete day 1 and morning and evening of complete day 2. 
#From FI_data, I can use the Date column and the corrected_intake_gr or corrected_intake_kcal
  #to obtain this information
#For BW loss, this is Sable day 13 and 14 (12-15 is the entire duration of the BW loss time period)
