...
#Equal variance (p value is 0.329 suggesting that there is not a sig diff in 
...
#Equal variance (p = 0.139 suggests that there is not a sig diff in the 
#variance within each group)
...
t.test_2B_BW <- echoMRI_data_2B %>%
  ...
  add_significance()
t.test_2B_BW
#p= 0.808 --> mean BW is not sig diff between 2 treatment groups
...
##Alternative method: use percent body fat ####
...
#Equal variance (p value is 0.350 suggesting that there is not a sig diff in 
#variance within each group)
