...
plot_raw_TEE_light <-ggplot(Light_Scaled_Photo_EE, aes(x = SABLE, y = scaled_TEE, fill = GROUP, color=GROUP)) +
  ...
  ylim(0,10)+
  labs(
    #title="Light cycle (12hrs): TEE",
    y = "Total energy expenditure (kcal/light phase)")
plot_raw_TEE_light
...
plot_raw_TEE_dark <-ggplot(Dark_Scaled_Photo_EE, aes(x = SABLE, y = scaled_TEE, fill = GROUP, color=GROUP)) +
  ...
  ylim(0,10)+
  labs(
    #title="Dark cycle (12hrs): TEE",
    y = "Total energy expenditure (kcal/dark phase)")
plot_raw_TEE_dark
...
plot_raw_RMR_dark <-ggplot(Dark_Scaled_Photo_EE, aes(x = SABLE, y = scaled_RMR, fill = GROUP, color=GROUP)) +
  ...
  ylim(0,10)+
  labs(
    #title="Dark cycle (12hrs): RMR",
    y = "Resting metabolic rate (kcal/dark phase)")
plot_raw_RMR_dark
...
plot_raw_RMR_light <-ggplot(Light_Scaled_Photo_EE, aes(x = SABLE, y = scaled_RMR, fill = GROUP, color=GROUP)) +
  ...
  ylim(0,10)+
  labs(
    #title="RMR: Light (12hrs)",
    y = "Resting metabolic rate (kcal/light phase)")
plot_raw_RMR_light
