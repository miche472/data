...
ggplot(Summary_Combined_avg_EE_hr_bins, 
  ...
  labs(x = "Dose", y = "Energy expenditure (kcal/hr)", title = "0 - 2 hrs post injection")

### Median EE (kcal/hr) vs Dose (including baseline) ####
ggplot(Summary_Combined_avg_EE_hr_bins, 
       aes(x = factor(DOSE), y = Avg_EE_0_2hr, fill = factor(DOSE))) +
  stat_summary(fun = median, geom = "bar", width = 0.6) + # Median bars
  stat_summary(fun.data = median_hilow, geom = "errorbar", width = 0.2) + # IQR error bars
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "MEDIAN EE (kcal/hr)", title = "0 - 2 hrs post injection")
...
ggplot(Summary_Combined_avg_EE_hr_bins, 
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "Energy expenditure (kcal/hr)",title = "2 - 4 hrs post injection")
...
ggplot(Summary_Combined_avg_EE_hr_bins, 
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "MEDIAN EE (kcal/hr)", title = "2 - 4 hrs post injection")
...
ggplot(Summary_Combined_avg_EE_hr_bins, 
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "Energy expenditure (kcal/hr)",title = "0 - 4 hrs post injection")
...
ggplot(Summary_Combined_avg_EE_hr_bins, 
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "MEDIAN EE (kcal/hr)", title = "0 - 4 hrs post injection")
...
ggplot(Summary_Combined_sum_loc_hr_bins, 
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "Total distance (m)", title = "0 - 2 hrs post injection")
...
ggplot(Summary_Combined_sum_ped_hr_bins, 
  ...
  scale_fill_manual(values = custom_colors_OXA) +
  scale_color_manual(values = custom_colors_OXA) +
  labs(x = "Dose", y = "Walking distance (m)", title = "0 - 2 hrs post injection")
