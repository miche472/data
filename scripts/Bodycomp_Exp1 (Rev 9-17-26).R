...
echoMRI_data_BWloss <- echoMRI_data_19 %>%
  ...
  mutate(DRUG = case_when(ID %in% c(3735, 3736, 3740) ~ "Vehicle",
         ...
         n_measurement = case_when(n_measurement == "1" ~ "Pre BW loss", # Day 0
                                   ...
                                   n_measurement == "3" ~ "BW loss", # Day 34
                                   n_measurement == "4" ~ "BW regain")) %>%
  mutate(
...
plot_echmoMRI_Exp1_delta <- echmoMRI_Exp1_delta %>%
...
BW_plot_G <-ggplot(plot_echmoMRI_Exp1_delta, aes(x=n_measurement, y=BW, group=DRUG, fill=DRUG, color=DRUG)) +
...
model_BW_G <- lmer(BW ~ n_measurement*DRUG + (1 | ID), data=echmoMRI_Exp1_delta)
summary(model_BW_G)
...
Lean_plot_G <-ggplot(plot_echmoMRI_Exp1_delta, aes(x=n_measurement, y=Lean, group=DRUG, fill=DRUG, color=DRUG)) +
  geom_point(stat = "summary", 
             fun = "mean", aes(color=DRUG), size=4, position = position_dodge(width = 0)) +
  geom_line(stat = "summary", 
            fun = "mean", aes(color=DRUG), linewidth=1, position = position_dodge(width = 0)) +
...
Fat_plot_G <-ggplot(plot_echmoMRI_Exp1_delta, aes(x=n_measurement, y=Fat, group=DRUG, fill=DRUG, color=DRUG)) +
  geom_point(stat = "summary", 
             fun = "mean", aes(color=DRUG), size=4, position = position_dodge(width = 0)) +
  geom_line(stat = "summary", 
            fun = "mean", aes(color=DRUG), linewidth=1, position = position_dodge(width = 0)) +
...
BW_pct_change_plot <-ggplot(plot_echmoMRI_Exp1_delta, aes(x=n_measurement, y=BW_pct_change, 
                                                     group=DRUG, fill=DRUG, color=DRUG)) +
  geom_point(stat = "summary", 
             fun = "mean", aes(color=DRUG), size=4) +
  geom_line(stat = "summary", 
...
ggsave(BW_pct_change_plot,
       filename="Exp1_BW_pct_change.png", 
       width = 6, 
       height = 4, 
       units = "in", 
       dpi = 300,
...
Lean_pct_change_plot <-ggplot(plot_echmoMRI_Exp1_delta, aes(x=n_measurement, y=Lean_pct_change, 
                                                       group=DRUG, fill=DRUG, color=DRUG)) +
...
ggsave(Lean_pct_change_plot,
       filename="Exp1_pct_change_lean.png", 
       width = 6, 
       height = 4, 
       units = "in", 
       dpi = 300,
...
Fat_pct_change_plot <-ggplot(plot_echmoMRI_Exp1_delta, aes(x=n_measurement, y=Fat_pct_change, 
                                                      group=DRUG, fill=DRUG, color=DRUG)) +
  geom_point(stat = "summary", fun = "mean", aes(color=DRUG), size=4) +
  geom_line(stat = "summary", fun = "mean", aes(color=DRUG), linewidth=1) +
  geom_errorbar(stat = "summary", fun.data = mean_se, aes(width=0.08), width=0.1) +
...
ggsave(Fat_pct_change_plot,
       filename="Exp1_pct_change_fat.png", 
       width = 6, 
       height = 4, 
       units = "in", 
       dpi = 300,
