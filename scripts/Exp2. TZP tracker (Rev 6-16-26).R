...
Exp2_tracker <- BW_FI_19 %>%
  ...
  mutate( 
    ...
    Treatment_day =case_when(COMMENTS=="INJECT_DAY_1_DOSE_ONE"~0,
                             COMMENTS=="SABLE_DAY_4_INJECT_DAY_1_DOSE_ONE"~0,
                             ...
                             COMMENTS=="SABLE_DAY_1_INJECT_DAY_1_DOSE_TWO"~7, #For 3747
                             
                             COMMENTS=="INJECT_DAY_2_DOSE_TWO"~8,
                             COMMENTS=="SABLE_DAY_2_INJECT_DAY_2_DOSE_TWO"~8, #For 3747
                             
                             COMMENTS=="INJECT_DAY_3_DOSE_TWO"~9,
                             COMMENTS=="SABLE_DAY_1_INJECT_DAY_3_DOSE_TWO"~9,
                             COMMENTS=="SABLE_DAY_3_INJECT_DAY_3_DOSE_TWO"~9, #For 3747
                             
                             COMMENTS=="INJECT_DAY_4_DOSE_TWO"~10,
                             COMMENTS=="SABLE_DAY_2_INJECT_DAY_4_DOSE_TWO"~10,
                             COMMENTS=="SABLE_DAY_4_INJECT_DAY_4_DOSE_TWO"~10, #For 3747
                             
                             COMMENTS=="INJECT_DAY_5_DOSE_TWO"~11,
                             COMMENTS=="SABLE_DAY_3_INJECT_DAY_5_DOSE_TWO"~11,
                             
                             COMMENTS=="INJECT_DAY_6_DOSE_TWO"~12,
                             COMMENTS=="SABLE_DAY_4_INJECT_DAY_6_DOSE_TWO"~12,
                             
                             COMMENTS=="INJECT_DAY_7_DOSE_TWO"~13,
                             COMMENTS=="SABLE_DAY_5_INJECT_DAY_7_DOSE_TWO" ~13,
