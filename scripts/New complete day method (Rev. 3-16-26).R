...
# Started: 2-26-26
#Revised: 3-2-26, minor updates for completeness and accuracy on 3-16-26. 
...
#Note, I tried doing FI and energy balance. Manual FI uses corrected_intake, so is likely not accurate.
#use the FI calculation from a later script
...
#-----MLR: EE (minute summation) adjusted for BW or Lean mass-----####
