...
#Cumulative intake for a 7 day "window" before "injections day one dose one"
#Cumulative intake for when Dose_step=10nmol/kg
#Cumulative intake for when Dose_step=20nmol/kg
