...
##Baseline: First day of LFD (first day of obesity development/start of ad lib LFD)
    ...
    STRAIN == "NZO/HlLtJ" & ID %in% c(3706, 3707, 3708, 3709, 3710, 3711) & DATE == as.Date("2024-11-20") ~ "Baseline", 
    STRAIN == "NZO/HlLtJ" & ID %in% c(3713, 3714, 3716, 3717, 3718, 3719) & DATE == as.Date("2024-11-27") ~ "Baseline",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3720, 3721, 3722, 3723, 3724, 3725, 3726) & DATE == as.Date("2024-12-04") ~ "Baseline",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3727, 3728, 3729) & DATE == as.Date("2024-12-11") ~ "Baseline",
  
##Peak obesity: End peak obesity period (last day of Peak obesity sable)
    #Sable day 10 or 11
      #STRAIN == "NZO/HlLtJ" & ID %in% c(3706, 3707, 3709, 3713, 3716, 3717) & DATE == as.Date("2025-02-07") ~ "Peak obesity", 
      #STRAIN == "NZO/HlLtJ" & ID %in% c(3719, 3726) & DATE == as.Date("2025-02-10") ~ "Peak obesity",
      #STRAIN == "NZO/HlLtJ" & ID %in% c(3711, 3718) & DATE == as.Date("2025-03-03") ~ "Peak obesity",
    #First day of restricted diet (for weight cycled mice. Date matching for Control mice)
    STRAIN == "NZO/HlLtJ" & ID %in% c(3708, 3710, 3714, 3720, 3721, 3722, 3723, 3724, 
                                     3725, 3728, 3729) & DATE == as.Date("2025-02-24") ~ "Peak obesity",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3706, 3707, 3709, 3711, 3713, 3716, 3717, 3718,
                                      3719, 3726) & DATE == as.Date("2025-02-24") ~ "Peak obesity",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3727) & DATE == as.Date("2025-03-10") ~ "Peak obesity",
...
##BW maintenance: End of Sable recording for BW maintenance
    ...
    STRAIN == "NZO/HlLtJ" & ID %in% c(3706, 3707, 3708) & DATE == as.Date("2025-06-12") ~ "BW maintenance",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3709, 3710, 3711) & DATE == as.Date("2025-06-13") ~ "BW maintenance",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3713, 3716) & DATE == as.Date("2025-06-18") ~ "BW maintenance",
    STRAIN == "NZO/HlLtJ" & ID %in% c(3714) & DATE == as.Date("2025-06-19") ~ "BW maintenance",
